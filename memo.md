...
### 11. アジャイル・スクラム開発 (セルフスクラム) の導入

本プロジェクトでは、開発プロセス自体も学習対象とし、アジャイル開発の手法を取り入れています。個人開発における「セルフスクラム」として、日次で計画と振り返りを行い、不確実性の高い MVP 開発に適応します。

日々の進捗と改善を記録するために、以下のフォーマットを使用します。
